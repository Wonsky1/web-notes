...
from web_notes.views import (
    ...
    TagDeleteView, change_pin_status, change_favourite_status, change_archive_status, ArchivedNoteListView,
)
...
urlpatterns = [
    ...
    path("change-pin-status/<int:pk>/", change_pin_status, name="note-change-pin-status"),
    path("change-favourite-status/<int:pk>/", change_favourite_status, name="note-change-favourite-status"),
    path("change-archive-status/<int:pk>/", change_archive_status, name="note-change-archive-status"),
]
